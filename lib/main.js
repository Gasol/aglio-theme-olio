...
(function() {
  ...
  getResources = function(resourceGroupElement, slugCache, resourceGroup) {
    var description, i, len, ref, ref1, resource, resourceElement, resources, slugify, title, title_slug;
    slugify = slug.bind(slug, slugCache);
    resources = [];
    ...
    for (i = 0, len = ref.length; i < len; i++) {
      ...
      resource = {
        ...
        actions: [],
        uriTemplate: ((ref1 = resourceElement.attributes) != null ? ref1.href.content : void 0) || ""
      };
