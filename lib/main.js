...
(function() {
  ...
  getParameters = function(actionElement, resourceElement) {
    var enumValue, example, hrefVariable, hrefVariables, i, len, parameter, parameters, ref, ref1, ref2, ref3, requiredElement, valueElement, values;
    parameters = [];
    hrefVariables = ((ref = actionElement.attributes) != null ? ref.hrefVariables : void 0) || {
      content: []
    };
    ref1 = hrefVariables.content;
    for (i = 0, len = ref1.length; i < len; i++) {
      ...
      switch (valueElement.element) {
        case 'enum':
          values = (function() {
            ...
            ref2 = valueElement.attributes.enumerations.content;
            results1 = [];
      ...
      parameter = {
        ...
        description: ((ref2 = hrefVariable.meta.description) != null ? ref2.content : void 0) || '',
        type: (ref3 = hrefVariable.meta.title) != null ? ref3.content : void 0,
